...
using Intent.Sample.Angular.Backend.Api.Configuration;
using Intent.Sample.Angular.Backend.Api.Filters;
using Intent.Sample.Angular.Backend.Api.Logging;
using Intent.Sample.Angular.Backend.Application;
using Intent.Sample.Angular.Backend.Infrastructure;
using Serilog;
...
namespace Intent.Sample.Angular.Backend.Api
{
