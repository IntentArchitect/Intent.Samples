...
[assembly: IntentTemplate("Intent.AspNetCore.IdentityService.TokenService", Version = "1.0")]
...
namespace eShop.Identity.Api.Services
{
    public class TokenService : ITokenService
    {
        ...
        public TokenService(IConfiguration configuration, IDataProtectionProvider provider)
        {
            ...
            _protector = provider.CreateProtector("eShop.Identity.Api.Services.TokenService");
        }
