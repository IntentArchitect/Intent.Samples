...
namespace eShop.Ordering.Infrastructure.Repositories.OrderAggregate
{
    ...
    public class OrderRepository : RepositoryBase<Order, Order, ApplicationDbContext>, IOrderRepository
    {
        ...
        public async Task<List<Order>> FindByIdsAsync(int[] ids, CancellationToken cancellationToken = default)
        {
