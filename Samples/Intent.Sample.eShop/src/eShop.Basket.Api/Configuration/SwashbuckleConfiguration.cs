...
using eShop.Basket.Api.Filters;
...
namespace eShop.Basket.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "eShop.Basket API V1");
                    options.OAuthAppName("eShop.Basket API");
