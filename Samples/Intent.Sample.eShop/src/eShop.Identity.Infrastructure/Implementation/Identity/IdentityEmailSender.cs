...
namespace eShop.Identity.Infrastructure.Implementation.Identity
{
    public class IdentityEmailSender : eShop.Identity.Application.Interfaces.IIdentityEmailSender
    {
